fun main(args: Array<String>) {
    println("Если предыдущая сумма покупок от 0 до 1 000 рублей, то никаких скидок нет.\n" +
...
if (vip == "y") {
    skidka = (sum/100)
    sum = (sum - skidka)
    println("Ваша дополнительная скидка как постоянному клиенту " + skidka/100.0 + " руб. \n" +
            "Ваша сумма покупки с учетом скидки составила: " + sum/100.0 + " руб.")

}else println ("Дополниетельных скидок нет")
